...
namespace Protein_Morph {
    ...
    template <class TVertex, class TFace>
    unsigned long long  TriangleMesh<TVertex, TFace>::AddVertex(TriangleMeshVertex<TVertex> vertex) {
    ...
    template <class TVertex, class TFace>
    unsigned long long  TriangleMesh<TVertex, TFace>::AddVertex(TriangleMeshVertex<TVertex> vertex, unsigned long long hashKey) {
        vertices[hashKey] = vertex;
        return hashKey;
    }

    template <class TVertex, class TFace>
    unsigned long long TriangleMesh<TVertex, TFace>::AddFace(TriangleMeshFace<TFace> face) {
    ...
    template <class TVertex, class TFace>
    unsigned long long TriangleMesh<TVertex, TFace>::AddFace(unsigned long long vertexHash0, unsigned long long vertexHash1, unsigned long long vertexHash2) {
    ...
    template <class TVertex, class TFace>
    Vector3Float TriangleMesh<TVertex, TFace>::GetVertexNormal(unsigned long long vertexHash) {
    ...
    template <class TVertex, class TFace>
    Vector3Float TriangleMesh<TVertex, TFace>::GetFaceNormal(unsigned long long faceHash) {
    ...
    template <class TVertex, class TFace>
    void TriangleMesh<TVertex, TFace>::Draw(bool drawSurfaces, bool annotateSurfaces, bool fadeExtreme, int radius, Vector3Float center) {
        int k;
        if(drawSurfaces) {
            if(annotateSurfaces) {
                glPushName(0);
