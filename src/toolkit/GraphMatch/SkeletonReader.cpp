...
namespace GraphMatch {
    ...
    void SkeletonReader::ReadSheetFile(char * sheetFile, vector<Shape*> & helixes){
    ...
    void SkeletonReader::ReadHelixFile(char * helixFile, char * sseFile, vector<Shape*> & helixes){
    ...
    void SkeletonReader::FindSizes(int startHelix, int startCell, vector<Shape*> & helixList, Volume * vol, Volume * coloredVol, StandardGraph * graph) {
    ...
    void SkeletonReader::FindPath(int startIx, int endIx, vector<vector<Vec3I> > nodes, Volume * maskVol, StandardGraph * graph, bool eraseMask) {
        // erase any old path
